...
//       }else {  //没有key
//           goods=goodsService.getgoofInfo(gid);//到数据库中查询  然后存在redis 中
...
//        }
//        curr_stock-=1;
//        redisUtils.set(goodstock+gid,curr_stock_str);
//        redisUtils.delete(lock+gid);
//        goodsService.updateStock(gid);
//        goodsService.addOrder(uid,gid);
//        redisUtils.set(getStatus+uid,getSuccess);
